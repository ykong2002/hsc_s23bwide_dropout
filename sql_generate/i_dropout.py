...
FROM
        ...
        AND meas2.z_sdsscentroid_flag = 'f'
        AND meas2.y_sdsscentroid_flag = 'f'
...
main.object_id in ("""
    ...
    AND main.z_cmodel_flag = 'f'
    AND main.y_cmodel_flag = 'f'
    AND main.merge_peak_g = 'f'
    AND main.merge_peak_r = 'f'
    AND main.merge_peak_i = 't'
    AND main.merge_peak_z = 't'
    AND meas2.z_blendedness_abs <= 0.2
    AND meas2.y_blendedness_abs <= 0.2
